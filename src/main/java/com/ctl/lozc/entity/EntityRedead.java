...
import com.ctl.lozc.procedure.ProcedureRedeadEntityIsHurt;
import com.ctl.lozc.Elements;

@Elements.ModElement.Tag
public class EntityRedead extends Elements.ModElement {
	public static final int ENTITYID = 1;
	public static final int ENTITYID_RANGED = 2;
	public EntityRedead(Elements instance) {
		super(instance, 1);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("lozc", "redead"), ENTITYID)
				.name("redead").tracker(64, 3, true).egg(-1, -1).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("plains")), Biome.REGISTRY.getObject(new ResourceLocation("desert")),
				Biome.REGISTRY.getObject(new ResourceLocation("forest")), Biome.REGISTRY.getObject(new ResourceLocation("hell")),
				Biome.REGISTRY.getObject(new ResourceLocation("beaches")),};
		EntityRegistry.addSpawn(EntityCustom.class, 15, 3, 30, EnumCreatureType.MONSTER, spawnBiomes);
		DungeonHooks.addDungeonMob(new ResourceLocation("lozc:redead"), 180);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("lozc:textures/edead__2.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureRedeadEntityIsHurt.executeProcedure($_dependencies);
			}
